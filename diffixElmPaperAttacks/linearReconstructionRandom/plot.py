...
colors = {'P': "red", 'XP': "orange", 'XXP': "blue"}
...
ax2 = sns.boxplot(x='a_pri',y='s_ci_av',data=df1,hue='a_lab',order=['none','half','all-but-one'],
                     palette=colors)
ax2.set(ylabel = 'Precision Improvement (PI)', xlabel='Attacker Prior Knowledge')
ax2.grid(axis='y')
...
shapes = rp.getShapes(params)
ax1.set(ylabel = 'Precision Improvement (PI)', xlabel='Length of Random Value')
